...
namespace ePACSLoans.Tests.SmokeTest
{
    ...
    [Category("Smoke")]
    [AllureNUnit]
    [Obsolete("This test class is deprecated. Use Credit limit instead.")]
    public class CreditLimitTest : BaseTest
    {
        private LoginPage? _loginPage;
        private DashboardPage? _dashboardPage;
        private CreditLimitPage? _creditLimitPage;
        private CreditLimitData? _testData;
        public override async Task SetUp()
        {
            ...
            try
            {
                ...
                NLog.ILogger logger = LogManager.GetLogger("CreditLimitTest");
                ...
                _creditLimitPage = new CreditLimitPage(Page!, waitHelper, logger, retryHelper, inputHelper, testDataProvider, locatorLoader);
        ...
        private async Task<CreditLimitData> LoadTestDataAsync()
        {
            try
            {
                var _objPath = new PathHelper();
            ...
            {
                Logger.Error("Failed to load credit limit test data", ex);
                throw;
            }
        }
        [Test]
        [Description("Verify user can save creditlimit details with all mandatory fields")]
        public async Task TestCreditLimitAsync()
        {
            await _creditLimitPage.SaveCreditlimitAsync(_dashboardPage!, _testData!);
        }
    }
}
