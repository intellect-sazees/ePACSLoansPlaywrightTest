...
namespace ePACSLoans.Tests.Functional_Test
{
    [TestFixture]
    [Category("Functional")]
    [AllureNUnit]
    [Obsolete("This test class is deprecated. Use Land Declaration instead.")]
    public class LandDeclarationFunctionalTest : BaseTest
    {
        ...
        [Test]
        [Description("Verify that the system validates the correct admission number")]
        public async Task TestAdnissionFildValidationAsync()
        {
