...
namespace ePACSLoans.Models.Locaters
{
    public class LandDeclarationLocaters
    {
        ...
        public string TotalLandInAcersInput { get; set; } = string.Empty;
        public string TotalLandInCentsInpu { get; set; } = string.Empty;
        public string CultivatableLandInAcersInput { get; set; } = string.Empty;
        public string CultivatableLandInCentsInput { get; set; } = string.Empty;
        public string TotalAvailableLandInAcersInput { get; set; } = string.Empty;
        public string TotalAvailableLandInCentsInput { get; set; } = string.Empty;
        public string LandDeclaredAcresInput { get; set; } = string.Empty;
